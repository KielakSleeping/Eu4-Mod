...
NDefines.NDiplomacy.IMPERIAL_AUTHORITY_FROM_PRINCES = 0.070 -- slight IA gain nerf
NDefines.NDiplomacy.IMPERIAL_REFORM_COST = 60 -- slight HRE nerf
NDefines.NDiplomacy.HRE_HERETIC_PENALTY = 0 -- slight HRE Buff
NDefines.NDiplomacy.IMPERIAL_REFORM_AUTHORITY_ACCEPTANCE = 3 -- So reforms get passed sooner after reaching 60 IA now that they cost more to pass
NDefines.NDiplomacy.HRE_FOREIGN_CONTROL_PENALTY = -0.006 -- slight HRE nerf, more incentive for HRE to get this back
...
NDefines.NEconomy.LAND_TECH_MAINTENANCE_IMPACT = 0.025 -- slightly increased maintanance penalty per mil tec, vanilla is 0.02	
...
NDefines.NMilitary.REVOLUTIONARY_GUARD_USES_CONSTRUCTION = 0 -- Revolutionary Guard Spawns instantly if 0
NDefines.NMilitary.REVOLUTIONARY_GUARD_STARTING_STRENGTH = 1.0 -- Revolutionary Guard Spawns at 1000 troops
NDefines.NMilitary.REVOLUTIONARY_GUARD_BASE_COST_MODIFIER = 1.0
...
NDefines.NAI.DEBASE_THRESHOLD = 0 -- So AI does not take corruption all the time
